...
const dataSaveToFile=JSON.stringify(arraydata)

//saving processed json data into file here.(file name is processed.json which we will get inside a project)
fs.writeFile("./processed.json", dataSaveToFile, (err) => {
    if (err) {
        console.error(err);
        return;
    };
